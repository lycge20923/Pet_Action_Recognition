...
def get_parser():
    ...
    # feeder
    parser.add_argument('--feeder', default='comparison.infogcn.feeders.feeder_PetAction.Feeder', help='data loader will be used')
    ...
    parser.add_argument('--graph', type=str, default='comparison.infogcn.graph.AP10K.Graph', help='')
    ...
    # individualization
    parser.add_argument('--fold_num', type=int, default=0, help="The fold number of the dataset")
    parser.add_argument('--mode', default="joint", choices=["joint", "bone"], help="The mode of streams")
    parser.add_argument('--patient_epochs', default=500, help="")
