...
if __name__ == '__main__':
    ...
    arg.testffnjifh = False
    
    # adjust work dir
    runs_dir = TrainingArguments().save_root_dir_name
    train_feeder_args = arg.train_feeder_args
    test_feeder_args = arg.test_feeder_args
    assert (train_feeder_args["bone"] == test_feeder_args["bone"]) and \
        (train_feeder_args["vel"] == test_feeder_args["vel"]) and\
        (train_feeder_args["data_path"] == test_feeder_args["data_path"]), "The setting of train and test dataset should be same"
