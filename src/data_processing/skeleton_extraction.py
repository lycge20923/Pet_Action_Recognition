...
def main():
    ...
    for id_, input_path in enumerate(seg_video_paths[:2]):
    ...
    txt = f"Avg Execution FPS: {sum_exec_fps / len(seg_video_paths[:2]):.2f}, Avg Keypoints Detection Rate: {sum_keypoint_detection_rate / len(seg_video_paths[:2]):.2f}"
